            ...
            <div class="row">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img class="d-block w-100"
                                    src="<?= self::loadImg("/fotos/".$first_photo['namePhoto']); ?>"
                                    alt="First slide">
                            </div>    
                            <?php foreach($photos as $photos): ?>
                            <div class="carousel-item">
                                <img class="d-block w-100"
                                    src="<?= self::loadImg("/fotos/".$photos['namePhoto']); ?>"
                                    alt="First slide">
                            </div>
                            <?php endforeach; ?>
                        </div>
                        <a class="carousel-control-prev" href="#carouselPhotos" role="button"
                            data-slide="prev">
                            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                            <span class="sr-only">Anterior</span>
                        </a>
                        <a class="carousel-control-next" href="#carouselPhotos" role="button"
                            data-slide="next">
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="product-inner">
                        <h1><?= $title ?></h1>
                        <div class="mt-3">
                            <p class="font-weight-bold h5 text-success">R$ <?= $product['price']; ?></p>
                        </div>
                        ...
                        <form action="<?= url('add.cart', ['id' => $product['idProduct']]); ?>" method="POST">
                            <div class="form-inline">
                                ...
                                <input type="number" size="4" class="form-control col-2" title="Qty" value="1"
                            ...
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab"
                                        aria-controls="home" aria-selected="true">Descrição do Produto</a>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="contact-tab" data-toggle="tab" href="#contato" role="tab"
                                        aria-controls="contact" aria-selected="false">Avaliar</a>
                                </li>
                            </ul>
                                    ...
                                    <form class="mt-3">
                                        ...
                                        <p class="mt-4">
                                            ...
                                            <textarea name="review" id="" cols="60" rows="10"
                                                class="form-control w-75 ml-2"></textarea>
                                        </p>
                                        <p>
